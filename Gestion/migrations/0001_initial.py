    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volume_heure_tp', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=6, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))], verbose_name='Volume heures TP contractuel')),
                ...
                ('taux_horaire_tp', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))], verbose_name='Taux horaire TP (FCFA)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volume_heure_tp', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=6, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Volume Heures TP')),
                ...
                ('taux_horaire_tp', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Taux Horaire TP (FCFA)')),
                ...
                ('notes_validation', models.TextField(blank=True, help_text='Notes du responsable RH sur ce module', verbose_name='Notes de validation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('heures_tp', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=5, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))], verbose_name='Heures de TP')),
                ('sujet_traite', models.CharField(blank=True, max_length=500, verbose_name='Sujet traité')),
                ('observations', models.TextField(blank=True, verbose_name='Observations')),
                ('taux_presence', models.IntegerField(blank=True, help_text="Pourcentage d'étudiants présents", null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Taux de présence (%)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes_proposition', models.TextField(blank=True, help_text='Notes ou commentaires lors de la création du précontrat', verbose_name='Notes de proposition')),
                ('notes_validation', models.TextField(blank=True, help_text='Notes du responsable RH lors de la validation', verbose_name='Notes de validation')),
